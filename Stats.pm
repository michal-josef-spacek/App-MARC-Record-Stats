...
App::MARC::Record::Stats - Base class for marc-record-stats script.

=head1 SYNOPSIS

 use App::MARC::Record::Stats;

 my $app = App::MARC::Record::Stats->new;
...
=head1 ERRORS
 ...
 run():
         Bad input MARC file.
         Cannot create object for MARC file.
         Input format '%s' doesn't supported.

=head1 EXAMPLE

=for comment filename=example_stat.pl
